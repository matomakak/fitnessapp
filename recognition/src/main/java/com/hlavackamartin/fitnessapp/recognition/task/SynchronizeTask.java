...
public class SynchronizeTask {
	...
	private void uploadData(File file) {
		...
		StringRequest postRequest = new StringRequest(Request.Method.POST, context.getString(R.string.upload_url),
	...
	private void onPostExecute(String errorMsg) {
		...
		dialog.dismiss();
		if (errorMsg != null)
			Toast.makeText(context, context.getString(R.string.sync_fail) + errorMsg, Toast.LENGTH_LONG).show();
		else
